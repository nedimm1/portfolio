  ...
  return (
    <main className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute top-10 -left-20 h-72 w-72 rounded-full bg-pink-300/40 blur-3xl animate-blob" />
        <div className="absolute top-40 right-0 h-80 w-80 rounded-full bg-purple-300/40 blur-3xl animate-blob [animation-delay:3s]" />
        <div className="absolute bottom-0 left-1/3 h-96 w-96 rounded-full bg-blue-300/30 blur-3xl animate-blob [animation-delay:6s]" />
      </div>
      ...
      >
        <div className="relative shrink-0 animate-float">
          <div className="absolute -inset-3 rounded-full bg-gradient-to-tr from-pink-400 via-purple-500 to-blue-500 blur-md opacity-70" />
          <div className="relative h-56 w-56 overflow-hidden rounded-full ring-4 ring-white shadow-2xl md:h-64 md:w-64">
            <Image
              src="/profile.svg"
              alt="Nedim Muminovic"
              fill
        ...
        <div className="flex-1 text-center md:text-left animate-fade-in-up">
          <span className="inline-block rounded-full bg-white/70 px-4 py-1.5 text-sm font-medium text-purple-700 shadow-sm ring-1 ring-purple-200">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3 md:justify-start">
            ...
            <a
              href="#contact"
              className="rounded-full bg-white/70 px-7 py-3 text-sm font-semibold text-slate-800 ring-1 ring-slate-200 backdrop-blur transition hover:bg-white"
            >
              Get in touch
            </a>
          </div>
      ...
      <section id="projects" className="mx-auto max-w-6xl px-6 py-16">
        ...
        <article className="glass group relative overflow-hidden rounded-3xl p-8 shadow-xl transition hover:shadow-2xl md:p-12">
          <div className="grid gap-8 md:grid-cols-[1fr,1.5fr] md:items-center">
            <div className="relative mx-auto flex h-56 w-56 items-center justify-center rounded-3xl bg-gradient-to-br from-pink-400 via-purple-500 to-blue-500 shadow-xl md:h-64 md:w-64">
              <span className="text-7xl md:text-8xl">🇸🇦</span>
              <div className="absolute -bottom-3 -right-3 rounded-2xl bg-white px-4 py-2 text-xs font-bold text-purple-700 shadow-lg">
                Live on stores
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link
                  ...
                  className="rounded-full bg-white/80 px-5 py-2.5 text-sm font-semibold text-slate-800 ring-1 ring-slate-200 transition hover:bg-white"
                >
                  Privacy policy →
                </Link>
              </div>
